 ...
 * `------+-----+-----+------+----'      `--------------------------------'
 *    .-------------------------.          .--------------------------.
 *    |ESC/ALT|ENT/META|SPC(SYM)|          |SPC(NUM)|BSPC/META|TAB/ALT|
 *    '-------------------------'          '--------------------------'
 */
[BASE] = LAYOUT_gergoplex(
    ...
    MT(MOD_LALT, KC_ESC), MT(MOD_LGUI, KC_ENT), LT(SYMB, KC_SPC),     LT(NUMB, KC_SPC), MT(MOD_RGUI, KC_BSPC), MT(MOD_LALT, KC_TAB)
    ),
